...
def predictor(model, image_link, category_id, entity_name):
    ...
    """
    image_path = os.path.join('images/sample_test', os.path.basename(image_link))  # Assume images are downloaded to 'images/test' folder
...
if __name__ == "__main__":
    ...
    output_filename = os.path.join(DATASET_FOLDER, 'sample-test_out.csv')
